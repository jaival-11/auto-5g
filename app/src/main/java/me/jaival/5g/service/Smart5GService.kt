...
class Smart5GService : Service() {
    ...
    companion object {
        ...
        const val ACTION_START = "me.jaival.5g.ACTION_START"
        const val ACTION_STOP = "me.jaival.5g.ACTION_STOP"
    }
